<template>
   <!-- <embed src="menu.pdf" scrolling="auto"
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-3">
              <img src="../assets/footer.png " style="height: 160px;" alt="logo" class="footer__logo mb-20">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
              <nav class="footer__links">
                <ul class="list-unstyled d-flex flex-wrap justify-content-center">
                  ...
                  <!-- <li><a href="#reserve">Contact Us</a></li> -->

                </ul>
              </nav>
              <div class="footer__copyright">
                <!-- <span>&copy; 2022 India Restaurant. | All Rights Reserved.</span> -->
              </div>
            </div>
          </div><!-- /.row -->
        </div><!-- /.container -->
    ...
    <a href="#headerhint"> <button id="scrollTopBtn" class="actived"><i class="fa-regular fa-circle-up"></i></button></a>
